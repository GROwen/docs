[Research](http://research.unimelb.edu.au/index.html#home) / [Work with us](http://research.unimelb.edu.au/index.html#work) / [How we support your research](http://research.unimelb.edu.au/how-we-support.html) / [ARC Funding](http://research.unimelb.edu.au/funding/arc/scheme-list.html)

## Linkage Infrastructure, Equipment and Facilities

OverviewHow to applySupport documentsContacts [Manage your grant](http://research.unimelb.edu.au/funding/arc/manage-your-grant.html)
...
The Linkage Infrastructure, Equipment and Facilities (LIEF) scheme provides funding for collaborative research infrastructure of critical mass. Typically involving multiple university partners contributing cash investment, the scale of facility value is between $150,000 and $2,000,000.
...
-
  ...
  - ooCommunication to proceed with the application development will be provided to the applicant by 19 February 2016.
...
- Confirmation of Funding (CoF)
  ...
  - ooRead the [UoM ARC LIEF Central Contributions Policy](http://cms.unimelb.edu.au/controlled-environment/research/assets/documents/20151215-ARC_LIEF-DVCR-Contribution-Policy_2017funding.docx.pdf) for guidance on support requests.

- Review funding documents

Review the LIEF 2017 [Funding Rules](http://research.unimelb.edu.au/funding/docs/Linkage_Programme_Funding_Rules_LIEF_2017.pdf), [Changes to Funding Rules](http://research.unimelb.edu.au/funding/docs/LE16_to_LE17_Funding_Rules_changes.pdf), Instructions to Applicants (not yet available, please see [here](http://research.unimelb.edu.au/funding/docs/LE16_Instructions_to_Applicants.pdf) for copies from previous years) and FAQs (not yet available, please see [here](http://research.unimelb.edu.au/funding/docs/Linkage-Program-FAQs_23.09.2015.pdf) for copies from previous years).

- Update RMS 2.0 profile and CV

Each CI and PI is required to have access to [RMS 2.0](https://rms.arc.gov.au) and update profile information (see [RMS information](http://www.arc.gov.au/rms-information))

Instructions to Applicants are yet to be released by the ARC.

- Submit 'Review ready' application to RIC

Prepare the application and submit the following to RIC via email at [arc-lief@unimelb.edu.au](mailto:arc-lief@unimelb.edu.au) by date to be confirmed pending release of ARC round dates (lead only):

-
  - ooAn electronic version of the 'review ready'
# \*
 draft application. _Note: A hard copy of the application is not required._
  - oo [Internal UOM Authority to Submit and Certification form](http://research.unimelb.edu.au/funding/docs/arc_lief_2017_internal_authority_to_submit.docx) (please note that external/partner organisations are not required to sign this form)
...
If applicable, a Request Not to Assess form needs to be submitted to [arc-lief@unimelb.edu.au](mailto:arc-lief@unimelb.edu.au) by with date to be confirmed pending release of ARC round dates if CIs would like to request the exclusion of a potential assessor.
...
Please note that applications without these signed documents will not be submitted to the ARC.
...
| MDHS | [Bryony Wakefield](mailto:mdhs-grants@unimelb.edu.au?subject=LIEF%202016) | Refer to Faculty |
...
-  [UoM ARC LIEF Central Contributions Policy](http://cms.unimelb.edu.au/controlled-environment/research/interim-private-files/20151215-ARC_LIEF-DVCR-Contribution-Policy_2017funding.docx.pdf)
-  [2016 CoF form](http://research.unimelb.edu.au/funding/docs/LIEF-2017-CoF-form.docx)_(docx. 23kb)_
-  [Research Budgets](http://research.unimelb.edu.au/funding/budgets/index.html)
-  [UoM Salary Scales](http://research.unimelb.edu.au/funding/docs/2017-LIEF-UoM-Salary-scales.xlsx)
-  [Internal (UoM) Authority to Submit and Certification Form](http://research.unimelb.edu.au/funding/docs/arc_lief_2017_internal_authority_to_submit.docx) (_docx. 27kb)_
-  [External/Partner Authority to Submit and Certification Form](http://research.unimelb.edu.au/funding/docs/arc_lief_2017_external_certification_and_authority_to_submit_form.docx)  (_docx. 35kb_)
-  [Part A8.2 template](http://research.unimelb.edu.au/funding/docs/arc_le16_table_a8.2_template_.5_cm_margins_a4.docx)
-  [Part A9.2 template](http://research.unimelb.edu.au/funding/docs/arc_le16_table_a9.2_template_.5_cm_margins_a4.docx)
-  [Part C1 template](http://research.unimelb.edu.au/funding/docs/arc_le16_part_c_template_0.5cm_margins_a4.doc)
-  [Part E1 Template](http://research.unimelb.edu.au/funding/docs/arc_le16_table_e1_template_.5cm_margins_a4.docx)
-  [Part E2 Template](http://research.unimelb.edu.au/funding/docs/arc_le16_table_e2_template_.5cm_margins_a4.doc)
-  [Part E3 Template](http://research.unimelb.edu.au/funding/docs/arc_le16_table_e3_template_.5cm_margins_a4.docx.doc)
-  [Part E4 Template](http://research.unimelb.edu.au/funding/docs/arc_le16_table_e4_template_.5cm_margins_a4.docx)
-  [Part G Template](http://research.unimelb.edu.au/funding/docs/arc_le16_table_g_template_.5cm_margins_a4.docx)

#### **ARC Documents**

-  [ARC LIEF website](http://www.arc.gov.au/linkage-infrastructure-equipment-and-facilities)
-  [ARC LIEF 2017 Funding Rules](http://research.unimelb.edu.au/funding/docs/Linkage_Programme_Funding_Rules_LIEF_2017.pdf)
-  [LIEF 2017 ARC Summary of Major Changes to Funding Rules](http://research.unimelb.edu.au/funding/docs/LE16_to_LE17_Funding_Rules_changes.pdf)
- ARC LIEF 2016 [Instructions to Applicants](http://research.unimelb.edu.au/funding/docs/LE16_Instructions_to_Applicants.pdf) and [FAQs](http://research.unimelb.edu.au/funding/docs/Linkage-Program-FAQs_23.09.2015.pdf)
...
LIEF questions and primary email [arc-lief@unimelb.edu.au](mailto:arc-lief@unimelb.edu.au)

### **Key contacts**

| [Rachel Ramsdale](mailto:rachel.ramsdale@unimelb.edu.au) | _for pre-award administration including EoIs and application process_ | _9035 3636_ |
| --- | --- | --- |
